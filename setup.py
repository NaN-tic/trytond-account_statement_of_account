...
name = 'trytonspain_account_statement_of_account'
...
setup(name=name,
    version=version,
    description='Tryton Account Statement Of Account Module',
    ...
    use_2to3=True,
    convert_2to3_doctests=['tests/scenario_statement_of_account.rst'],
    )
